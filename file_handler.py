...
def handle_upload(file: UploadFile, file_paths: Dict[str, Path]) -> Tuple[Path, Path]:
    ...
    try:
        ...
        # Finding the extracted .txt file
        txt_file = None
        ...
        # Moving the txt file to user's directory
        shutil.move(str(txt_file), str(file_paths["txt"]))
        
        # Cleaning up the extracted directory
        ...
        # Cleaning up any partially created files
